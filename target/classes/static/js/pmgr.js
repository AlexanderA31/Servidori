...
//    const serverUrl = "http://gin.fdi.ucm.es/iu/api/";
    ...
    // ejemplo de login - DESACTIVADO PARA NO GENERAR DATOS FALSOS
    // Si necesitas datos de prueba, usa el panel de administración para crearlos
    console.log("Sistema de Gestión de Impresoras - Inicia sesión para ver tus datos");
    
    // NO generamos datos automáticamente
